    ...
    <div className="min-h-screen font-sans relative selection:bg-[#A9D87A] selection:text-[#1F2517] overflow-x-hidden flex flex-col" style={{ backgroundColor: colors.bgMain, color: colors.primary }}>
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto flex flex-col flex-1 pb-16 shadow-2xl shadow-black/5 bg-white/40 backdrop-blur-3xl min-h-screen">
        ...
        <a 
          ...
          className="absolute top-6 left-6 w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all z-20 group hover:scale-105 active:scale-95"
          title="Contactar por WhatsApp"
          style={{ backgroundColor: colors.accent, border: `1px solid ${colors.bgCard}` }}
        >
          <svg className="w-6 h-6 fill-current group-hover:scale-110 transition-transform" style={{ color: '#1A2211' }} viewBox="0 0 24 24">
